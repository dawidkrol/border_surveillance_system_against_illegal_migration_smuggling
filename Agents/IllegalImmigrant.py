...
class IllegalImmigrant(Agent):
    def __init__(self, unique_id, model, x, y, speed, tool_efficiency, percent_of_chance_to_choose_to_destroy_the_obstacle_if_there_is_already_a_destroyed):
    ...
    def fence_managing(self, border_fence_places):
        ...
        if len(destroyed_border_fence_places) == 0 or\
            ...
            self.choose_fance_place_to_destroy(border_fence_places)
        else:
    ...
    def choose_fance_place_to_destroy(self, border_fence_places):
    ...
    def move(self):
            if self.destroying_fence is not None and self.destroying_fence.is_destroyed == False:
    ...
    def try_to_destroy_border_fence(self, border_fence_place: BorderFence):
        ...
        print('resilience:', border_fence_place.resilience)
